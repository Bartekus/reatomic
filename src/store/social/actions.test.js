...
test('socialLoginPrepare', () => {
  expect(actions.socialLoginPrepare('facebook'))
    .toEqual({
  ...
  expect(actions.socialLoginPrepare('facebook', { clientId: 'foo' }))
    .toEqual({
      type: actions.SOCIAL_LOGIN_PREPARE,
      payload: {
        service: 'facebook',
...
test('socialLoginSuccess', () => {
  expect(actions.socialLoginSuccess(1, 'foo'))
    .toEqual({
...
test('socialLoginFailure', () => {
  expect(actions.socialLoginFailure('test', 'foo'))
    .toEqual({
...
test('socialLogout', () => {
  expect(actions.socialLogout())
    .toEqual({ type: actions.SOCIAL_LOGOUT });
});
